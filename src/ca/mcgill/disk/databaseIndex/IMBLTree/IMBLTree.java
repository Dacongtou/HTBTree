...
import ca.mcgill.disk.databaseIndex.IMBLTree.test.IntegerNode;
import ca.mcgill.disk.databaseIndex.IMBLTree.test.StringNode;
...
public class IMBLTree {
	...
	// remove method
	private DeepCopyObject remove(final DeepCopyObject key,
